...
var PersonHoverbox = Class.create(AbstractHoverbox, {
  ...
  generateHandles: function($super) {
    ...
    translate('Click to create a sibling or drag to an existing parentless person (valid choices will be highlighted in green)'));
    ...
    if (editor.getGraph().getParentRelationship(node.getID()) === null) {
      ...
      translate('Click to create new nodes for the parents or drag to an existing person or partnership (valid choices will be highlighted in green). Dragging to a person will create a new relationship.'));
    }
    ...
    if (!node.isFetus()) {
      ...
      if (node.getChildlessStatus() === null) {
        ...
        translate('Click to create a new child node or drag to an existing parentless person (valid choices will be highlighted in green)'));
      }
      ...
      translate('Click to create a new partner node or drag to an existing node (valid choices will be highlighted in green)'));
    }
