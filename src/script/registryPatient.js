...
var RegistryPatient = Class.create( {
  ...
  initialize: function(registryPatientID, name, callWhenReady) {
    ...
    console.log("registryPatientID",registryPatientID);

    this._registryPatientID  = RegistryPatient.sanitizeID(registryPatientID.trim());
...
RegistryPatient.desanitizeID = function(id) {
  ...
  temp = RegistryPatient.transliterate(temp, "toRus");
